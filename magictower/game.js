...
game.get_item("#reset").addEventListener("click", game.clearProcess);

game.get_items(".logo").forEach((e)=>{
    e.innerHTML = `
    <svg focusable="false" class="" data-icon="github" width="1em" height="1em" fill="currentColor" aria-hidden="true" viewBox="64 64 896 896">
